...
Q_CONSTINIT const QMetaObject TcpServer::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTcpServerENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'threadCompleted'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'handleClientConnection'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'forwardReceivedMessage'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'removeTheClient'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void TcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->newMessageReceived(); break;
        case 2: _t->threadCompleted(); break;
        case 3: _t->handleClientConnection(); break;
        case 4: _t->forwardReceivedMessage(); break;
        case 5: _t->removeTheClient(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &TcpServer::serverStarted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TcpServer::*)();
            if (_t _q_method = &TcpServer::newMessageReceived; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TcpServer::*)();
            if (_t _q_method = &TcpServer::threadCompleted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void TcpServer::serverStarted()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void TcpServer::newMessageReceived()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void TcpServer::threadCompleted()
{
